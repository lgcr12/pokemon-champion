...
export function TeamForge() {
  ...
  const restoreDefaultTeam = () => {
    setTeam(INITIAL_TEAM.map((member, index) => normalizeTeamMember({ ...member, moves: [...member.moves], moveLabels: [...member.moveLabels], types: [...member.types] }, index)));
