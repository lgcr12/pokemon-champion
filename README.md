...
```text
一个用 AI 辅助开发的宝可梦竞技队伍构筑工具。
支持单打/双打环境数据、热门队伍导入、配置编辑、基础规则检查和 Showdown / PKHeX 友好导出。
```

推荐 GitHub Topics：

```text
pokemon, pokemon-showdown, pkhex, team-builder, ai, openai-compatible, qwen, kimi, deepseek
```
